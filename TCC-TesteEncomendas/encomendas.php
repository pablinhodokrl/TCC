...
<a class="logo" href="busca-de-produtos.php"> 
    ...
    <a href="pg-perfil.php" class="align-middle">
       <!--  <p class="align-text-bottom">
        <svg xmlns="http://www.w3.org/2000/svg" width="50%" height="50%" class="bi bi-person-square" viewBox="0 0 16 16">
            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
            <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm12 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1v-1c0-1-1-4-6-4s-6 3-6 4v1a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12z"/>
        </svg>
        </p> -->

        <img src="imgs/profile-image.png" alt="" id="img-profile">
    </a>
                            ...
                            while($linha = mysqli_fetch_array($resultado))
                            {
                              ?>
                                  ...
                                  <div class="card">
                                      ...
                                      <h5 class="mb-0">
                                          <button class="btn btn-link" data-toggle="collapse" data-target="#c" aria-expanded="true" aria-controls="collapseOne">
                                          Collapsible Group Item #1
                                          </button>
                                      </h5>
                                      </div>

                                      <div id="c" class="collapse" aria-labelledby="1" data-parent="#accordion">
                                      <div class="card-body">
