                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-8">
                        <div class="card">
                           ...
                           $sql = "SELECT * FROM cadastroproduto WHERE id = $usuario[id]";
                            ...
                            ?>
                                ...
                                <form action="proc-editar-produto.php" method="POST">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input class="form-control" type="text" name="NomeProduto" id="email" placeholder="Ex: Água" value="<?php echo $usuario['NomeProduto']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Validade</label>
                                        <input class="form-control" type="date" name="Validade" id="email" placeholder="Digite o seu e-mail...">
                                    </div>
                                    <div class="form-group">
