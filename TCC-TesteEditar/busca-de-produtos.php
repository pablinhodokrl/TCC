                          ...
                          <tbody>                      
                            ...
                            while($linha = mysqli_fetch_array($resultado))
                            {
                               echo '<tr>';                  
                                   ...
                                   Mostrar</button>&nbsp
                                   <a href='editar-produto.php'> <button type='button' class='btn btn-sm btn-warning'>Editar
                                   
                              

                                   </button>&nbsp</a>
                                   <button type='button' class='btn btn-sm btn-danger' data-toggle='modal' data-target='#apagar$linha[id]'>Deletar</button>&nbsp</td>"; 
